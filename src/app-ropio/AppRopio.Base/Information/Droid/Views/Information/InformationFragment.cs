...
namespace AppRopio.Base.Information.Droid.Views.Information
{
    public class InformationFragment : CommonFragment<IInformationViewModel>
    {
        public InformationFragment()
            : base (Resource.Layout.app_information_info)
        {
